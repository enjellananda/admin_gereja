<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open_multipart('kotbah/edit/'.$kotbah['id_kotbah']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="date" name="tanggal_kotbah" value="<?php echo ($this->input->post('tanggal_kotbah') ? $this->input->post('tanggal_kotbah') : $kotbah['tanggal_kotbah']); ?>" class="form-control" id="tanggal_kotbah" />
