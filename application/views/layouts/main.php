        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">gkjw_dinoyo</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">gkjw_dinoyo</span>
                </a>
                        ...
                        <!-- User Account: style can be found in dropdown.less -->
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <!-- <span class="hidden-xs">Hi, <?php echo $user->username; ?></span> -->
                                    <span class="hidden-xs"><?php echo $this->session->userdata('username'); ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="<?php echo site_url('resources/img/user2-160x160.jpg');?>" class="img-circle" a Image">
            ...
            <footer class="main-footer">
                <strong>Generated By Politeknik Negri Malang 2019</strong>
            </footer>
