    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Jemaat Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tanggal_sidi" value="<?php echo $this->input->post('tanggal_sidi'); ?>" class="has-datepicker form-control" id="tanggal_sidi" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nama_pasangan" class="control-label">Nama Pasangan</label>
						<div class="form-group">
							<input type="text" name="nama_pasangan" value="<?php echo $this->input->post('nama_pasangan'); ?>" class="form-control" id="nama_pasangan" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="gereja_pasangan" class="control-label">Gereja Pasangan</label>
						<div class="form-group">
							<input type="text" name="gereja_pasangan" value="<?php echo $this->input->post('gereja_pasangan'); ?>" class="form-control" id="gereja_pasangan" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nomor induk_perkawinan" class="control-label">Nomor Induk Perkawinan</label>
						<div class="form-group">
							<input type="text" name="nomor induk_perkawinan" value="<?php echo $this->input->post('nomor induk_perkawinan'); ?>" class="form-control" id="nomor induk_perkawinan" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tempat_catatan_sipil" class="control-label">Tempat Catatan Sipil</label>
						<div class="form-group">
							<input type="text" name="tempat_catatan_sipil" value="<?php echo $this->input->post('tempat_catatan_sipil'); ?>" class="form-control" id="tempat_catatan_sipil" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tanggal_catatan_sipil" class="control-label">Tanggal Catatan Sipil</label>
						<div class="form-group">
							<input type="text" name="tanggal_catatan_sipil" value="<?php echo $this->input->post('tanggal_catatan_sipil'); ?>" class="has-datepicker form-control" id="tanggal_catatan_sipil" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="gereja_pemberkatan" class="control-label">Gereja Pemberkatan</label>
						<div class="form-group">
							<input type="text" name="gereja_pemberkatan" value="<?php echo $this->input->post('gereja_pemberkatan'); ?>" class="form-control" id="gereja_pemberkatan" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tanggal_pemberkatan" class="control-label">Tanggal Pemberkatan</label>
						<div class="form-group">
							<input type="text" name="tanggal_pemberkatan" value="<?php echo $this->input->post('tanggal_pemberkatan'); ?>" class="has-datepicker form-control" id="tanggal_pemberkatan" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tanggal_cerai" class="control-label">Tanggal Cerai</label>
						<div class="form-group">
							<input type="text" name="tanggal_cerai" value="<?php echo $this->input->post('tanggal_cerai'); ?>" class="has-datepicker form-control" id="tanggal_cerai" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="pindah_gereja" class="control-label">Pindah Gereja</label>
						<div class="form-group">
							<input type="text" name="pindah_gereja" value="<?php echo $this->input->post('pindah_gereja'); ?>" class="form-control" id="pindah_gereja" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tanggal_pindah_gereja" class="control-label">Tanggal Pindah Gereja</label>
						<div class="form-group">
							<input type="text" name="tanggal_pindah_gereja" value="<?php echo $this->input->post('tanggal_pindah_gereja'); ?>" class="has-datepicker form-control" id="tanggal_pindah_gereja" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nomor_surat_pindah" class="control-label">Nomor Surat Pindah</label>
						<div class="form-group">
							<input type="text" name="nomor_surat_pindah" value="<?php echo $this->input->post('nomor_surat_pindah'); ?>" class="form-control" id="nomor_surat_pindah" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tanggal_keluar" class="control-label">Tanggal Keluar</label>
						<div class="form-group">
							<input type="text" name="tanggal_keluar" value="<?php echo $this->input->post('tanggal_keluar'); ?>" class="has-datepicker form-control" id="tanggal_keluar" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nama_jemaat" class="control-label">Nama Jemaat</label>
						<div class="form-group">
							<input type="text" name="nama_jemaat" value="<?php echo $this->input->post('nama_jemaat'); ?>" class="form-control" id="nama_jemaat" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="surat_keterangan" value="<?php echo $this->input->post('surat_keterangan'); ?>" class="form-control" id="surat_keterangan" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nama_ayah" value="<?php echo $this->input->post('nama_ayah'); ?>" class="form-control" id="nama_ayah" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nama_ibu" class="control-label">Nama Ibu</label>
						<div class="form-group">
							<input type="text" name="nama_ibu" value="<?php echo $this->input->post('nama_ibu'); ?>" class="form-control" id="nama_ibu" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="gereja_baptis" class="control-label">Gereja Baptis</label>
						<div class="form-group">
							<input type="text" name="gereja_baptis" value="<?php echo $this->input->post('gereja_baptis'); ?>" class="form-control" id="gereja_baptis" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="gereja_sidi" class="control-label">Gereja Sidi</label>
						<div class="form-group">
							<input type="text" name="gereja_sidi" value="<?php echo $this->input->post('gereja_sidi'); ?>" class="form-control" id="gereja_sidi" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tanggal baptis" class="control-label">Tanggal Baptis</label>
						<div class="form-group">
							<input type="text" name="tanggal baptis" value="<?php echo $this->input->post('tanggal baptis'); ?>" class="has-datepicker form-control" id="tanggal baptis" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="alasan_cerai" class="control-label">Alasan Cerai</label>
						<div class="form-group">
							<textarea name="alasan_cerai" class="form-control" id="alasan_cerai"><?php echo $this->input->post('alasan_cerai'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
