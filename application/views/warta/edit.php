			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="date" name="tanggal_terbit" value="<?php echo ($this->input->post('tanggal_terbit') ? $this->input->post('tanggal_terbit') : $warta['tanggal_terbit']); ?>" class="has-datepicker form-control" id="tanggal_terbit" />
