<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('warta/edit/'.$warta['id_warta']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_admin" class="form-control">
								...
								{
									$selected = ($admin['id_admin'] == $warta['id_admin']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tanggal_terbit" value="<?php echo ($this->input->post('tanggal_terbit') ? $this->input->post('tanggal_terbit') : $warta['tanggal_terbit']); ?>" class="has-datepicker form-control" id="tanggal_terbit" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="wartajemaat" value="<?php echo ($this->input->post('wartajemaat') ? $this->input->post('wartajemaat') : $warta['wartajemaat']); ?>" class="form-control" id="wartajemaat" />
